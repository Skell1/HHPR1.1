...
public class Main {
    ...
    public static int find(ArrayList<Integer> first,ArrayList<Integer> second,int s) {
        ...
        int a = sizeFirst>0 ? first.get(sizeFirst-1) : 0;
        int b =sizeSecond>0 ? second.get(sizeSecond-1):0;
        ...
        while (a+b>s){
            ...
            a = sizeFirst==0? 0:first.get(sizeFirst-1);
            b = sizeSecond==0? 0:second.get(sizeSecond-1);
        }
